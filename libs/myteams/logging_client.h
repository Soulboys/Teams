...
//! Handler called when a user connect to the basic_server (you or someone else)
/*!
...
//! Handler called when a user disconnect from the basic_server (you or someone else)
/*!
...
//! Handler called when the user ask for the users list (/info CLI command), used in a reception over each team
/*!
...
//! Handler called when the user ask for the team list (/info CLI command), used in a reception over each team
/*!
	\param team_id a character pointer corresponding to the universally unique id assigned to the team.
	\param team_name a character pointer corresponding to the team's name.
	\param team_description a character pointer corresponding to the team's description.
...
//! Handler called when the user select a specific team to be in (/info CLI command), used in a reception over each channel
/*!
	\param channel_id a character pointer corresponding to the universally unique id assigned to the channel in the team.
	\param channel_name a character pointer corresponding to the channel's name.
	\param channel_description a character pointer corresponding to the channel's description.
...
//! Handler called when the user select a specific channel to be in (/info CLI command), used in a reception over each thread
/*!
	\param thread_id a character pointer corresponding to the universally unique id assigned to the thread in the team.
	\param user_id a character pointer corresponding to the universally unique id assigned to the user who created the thread.
	\param thread_timestamp an unsigned integer corresponding to the timestamp of the thread's creation.
...
//! Handler called when the user ask for a specific thread (/info CLI command), used in a reception over each reply
/*!
...
//! Handler called when the user ask for a specific private discussion (/messages CLI command), used in a reception over each message
/*!
...
//! Handler called when the user want to perform an action that was refused by the basic_server because the resource was already existing
/*!
	\return On success, 1 is returned. On error, -1 is returned and errno is set appropriately
*/
